...
4: The page will load and run the tests; the test result will be shown at the bottom of the page.
5: If all of the test pass, they will be displayed in green. If any of the tests fail, they will be displayed in red.
6: The actual test file can be found in the jasmine folder --> spec folder --> feedreader.js
